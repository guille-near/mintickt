<template>
  <section id="events" class="align divcol gap">
        ...
        <div class="divwrap_inv" style="gap:1em">
          ...
          <!-- <v-menu :close-on-content-click="false" offset-y>
            <template v-slot:activator="{on, attrs}"> -->
              <v-btn v-on="on" v-bind="attrs" to="/events/options"><v-icon size="1.5em">mdi-cog-outline</v-icon></v-btn>
            <!-- </template>
    ...
    <section class="vermobile">
      <v-card v-for="(item,i) in dataTableMobile" :key="i" class="up divcol" style="display:flex">
        <section class="acenter">
          ...
          <aside class="acenter" style="gap:.5em">
            ...
            <v-icon color="white" :style="item.show?'transform:rotate(180deg)':''" size="2em"
...
export default {
  ...
  methods: {
    mintMore(item2, item) {
      if (item2.name=='Mint') {this.modalMore=true;this.cantidad=item.mint_more}
    },
