      ...
      >
        <div class="containerTicket divcol relative">
          ...
          <v-btn
            class="arrows"
            icon
            @click="passTicket > 1 ? passTicket-- : null"
            :class="{ active: passTicket > 1 }"
            :disabled="passTicket == 1"
          >
          ...
          <v-btn
            class="arrows"
            icon
            @click="passTicket < 4 ? passTicket++ : null"
            :class="{ active: passTicket < 4 }"
            :disabled="passTicket == 4"
          >
        ...
        <div style="gap: 1em" class="divcol fill-w">
          ...
          <v-btn @click="handleSignIn()" class="paycard h8-em">
            Pay with card
          </v-btn>
        </div>
      </article>
...
export default {
  ...
  methods: {
    ...
    async traerdatos() {
      console.log(this.lists_aggregate);
      this.tittle = "NEARCON";
